...
public class practicaAventuraConversacional {
	...
	public static void main(String[] args) {
		...
		} while (!terminar && barraDeVida > 0 && !ending && !trueEnding && !badEnding);
		
		elegirFinal(terminar); // Se acaba el juego
	...
	private static void elegirFinal(boolean terminar) {
		if (trueEnding) {
		...
		} else if (numeroChoques == 100){
			System.out.println("Te ha dado un derrame cerebral de tanto chocarte con las paredes");
		} else {	
